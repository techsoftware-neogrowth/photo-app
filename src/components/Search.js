...
import {fetchLeadsIfNeeded, getChangeLeadListAction} from '../actions/leadlists'
...
class Search extends React.Component {
  ...
  renderContent () {
    let { leadListReducer } = this.props
    return (
      <Songs
        {...this.props}
  ...
  renderDisplay () {
    return (
      <LeadDisplayContainer />
    )
  }

  onSubmitEditing () {
    const {dispatch} = this.props
    dispatch(getChangeLeadListAction(this.state.text))
  }

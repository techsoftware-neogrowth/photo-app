...
import { addLead } from './../actions/leadlists'
...
class LeadAdd extends React.Component {
  constructor (props) {
    super(props);
    this.state = {};
 }
  ...
  addLead() {
    ...
    InteractionManager.runAfterInteractions(() => {
      dispatch(addLead(leadListReducer, this.state))
    })
  }
    ...
    return (
      <View style={styles.container}>
        <ToolbarAndroid
          ...
          onIconClicked={this.addLead.bind(this)}
          titleColor='#fff'
